...
|----|------|-------------|---------------------|--------|
| N1 | 1 | Create **≥ 5 new node types** to demonstrate the abstraction | At least 5 distinct new nodes exist and are usable on the canvas | ✅ 8 delivered (Condition, Merge, Filter List, Document Loader, Context Builder, Context Search, Web Scraper, Note); PE + RAG focused |
